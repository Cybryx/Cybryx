...
export const Replit = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1156 1156" {...props}>
    <g className="cls-1">
      <path
      ...
      ></path>
      <path
        d="M617.54 361.07S152 231.06 159.16 738.68a449.86 449.86 0 00108.49 162.17c2 1.89 4.07 3.68 6.09 5.54a450.17 450.17 0 0042.54 34.67c2.31 1.65 4.48 3.47 6.8 5.08a446.74 446.74 0 0049.11 29.16c4.93 2.54 10 4.86 15 7.23a443.91 443.91 0 0044.85 18.2c3.75 1.28 7.33 2.88 11.13 4.07A444.68 444.68 0 00499 1018c5.71 1 11.48 1.84 17.26 2.64a450 450 0 0059.11 4.59c.76 0 1.49.12 2.25.12 14.92 0 29.65-.8 44.18-2.23C99.46 898.55 298 314.47 617.54 361.07z"
        className="cls-2"
      ></path>
      <path
        d="M799 601.8s110.14-464.34-385.64-443.6c-166.25 65.67-283.94 227.43-283.94 417a451.1 451.1 0 004.61 61C238.37 110.86 832.8 281 799 601.8z"
        className="cls-2"
      ></path>
      <path
        d="M560.95 801.62s466.35 60.88 437.16-382.51C934.64 248.44 770.76 126.62 578 126.62a450.24 450.24 0 00-81.35 7.73c519.64 63.79 384.58 671.81 64.3 667.27z"
        className="cls-2"
      ></path>
      <path
        d="M707.46 575.25A125.65 125.65 0 11581.85 449.6a125.64 125.64 0 01125.61 125.65z"
        className="cls-3"
      ></path>
    </g>
  </svg>
...
return (
  ...
  >
    ...
    <path
      fill="#FFF"
      d="M29.994 18c0 3.314-1.092 6.559-3.264 8.73s-5.417 2.798-8.73 2.798-6.089-1.096-8.261-3.267S6.312 21.314 6.312 18s.9-6.445 3.071-8.617S14.686 5.608 18 5.608s6.203 1.846 8.375 4.017 3.619 5.061 3.619 8.375z"
    ></path>
    <path
      fill="#88C9F9"
      d="M25.871 18c0 4.418-3.453 8.112-7.871 8.112S10.261 22.418 10.261 18s3.321-7.785 7.739-7.785 7.871 3.367 7.871 7.785z"
    ></path>
    <path
      fill="#292F33"
      d="M23.075 17.825c0 2.665-2.235 4.908-4.9 4.908s-4.732-2.243-4.732-4.908 2.067-4.835 4.732-4.835 4.9 2.17 4.9 4.835z"
    ></path>
  </svg>
);
}
export const Khanda = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"

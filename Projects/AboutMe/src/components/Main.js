...
import SecretButton from '../subComponents/SecretButton'
...
z-index:1;
`
const MERCH = styled(NavLink)`
color: ${props => props.theme.text};
position: absolute;
top: 50.5%;
right: calc(0.1rem + 2vw);
...
bottom: 0;
right: 50%;
width: ${props => props.click ? '50%' : '.125%'};
    ...
    return (
        <MainContainer>
            ...
            <Container>
                ...
                <Center click={click}>
                    <Nazar onClick={() => handleClick()} width={click ? 50 : 200} height={click ? 50 : 200} fill='currentColor' />

...
const ConfirmPage = () => {
    ...
    useEffect(() => {
        ...
        if (name && subject) {
            ...
            setStatus('Failure:(')
            setButton(<button className="confirm-button submit" onClick={() => navigate("/contact")}>Try Again!</button>);
            setMessage('Your message was not received, check your connection.')
        }
    }, [navigate]);
